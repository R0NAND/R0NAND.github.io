...
ronan_world.addBody(new RidgidCircle(3, 5, 75, 150, 0, 0));
ronan_world.addBody(new RidgidCircle(3, 5, 85, 150, 0, 0));
ronan_world.addBody(new RidgidCircle(5, 8, 100, 110, 0, 0));
ronan_world.addBody(new RidgidCircle(1, 3, 115, 110, 0, 0));
ronan_world.addBody(new RidgidCircle(1, 3, 125, 110, 0, 0));
